...
const Page = (props) => {
  ...
  const navigation = {
    ...
    nextPage: {
      ...
      title: 'Стиральная машина зависает на програм��е'
    }
  }
  ...
  const problemSections = [
    ...
    },
    {
      ...
      content: `Мозг стиральной машины — это управляющая плата. Именно она хранит программы стирки и управляет всеми процессами. Если она выхо��ит из строя, техника не запускается, индикаторы не горят или ведут себя странно. Иногда помогает простой сброс: отключите питание на 10���20 минут и попробуйте снова. Если не помогло — скорее всего, нужна прошивка, ремонт или замена модуля. Этим обычно занимается специалист.`
    },
    {
      id: "5",
          ...
          <div className="page-container13">
            ...
            <div className="vicetext">
              ...
              <p>
                ...
                Если машинка всё ещё не подаёт признаков жизни, ��смотрите сетевой фильтр и впускной клапан. Для фильтра нужен мультиметр, для клапана — визуальный осмотр или звон мастеру. Часто эти детали меняют полностью.
              </p>
            </div>
          </div>
        </section>
