    ...
    <>
      <main className="frame1196-container100">
          ...
          <article className="frame1196-cards">
            ...
            <Link legacyBehavior href="/protekaet">
              <a className="frame1196-container115">
                ...
                <div className="frame1196-image17"><Image alt="Стиральн��я машина протекает" src="/problems 2/31-300h.webp" fill sizes="149px" quality={100} priority loading="eager" style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            ...
            <Link legacyBehavior href="/nenabiraetvodu">
              <a className="frame1196-container120">
                ...
                <div className="frame1196-image22"><Image alt="С��иральная машина не набирает воду" src="/problems/8-300h.webp" fill sizes="149px" quality={100} priority loading="eager" style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
                    ...
                    <h3 className="frame1196-text218">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: 'Современное оборудованиее по д��аагностике',
                        }}
                      ></span>
                    </h3>
                    <svg
          ...
          <div className="frame1196-container212">
            ...
            <div className={`frame1196-otvet2 ${activeFAQ === 2 ? 'faq-active' : ''}`}>
                <p className="frame1196-text242">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'На все виды работ даем гарантию 6 месяцев, на замененые за��части - 1 год. Гарантийный талон выдается сразу после завершения ремонта',
                    }}
                  ></span>
                </p>
            </div>
        ...
        <div className="frame1196-container225">
          ...
          <p className="frame1196-text260 textITOGI">
            <span
              dangerouslySetInnerHTML={{
                  __html: 'Ремонт стиральных машин в Одессе необходим как новым, так и давно использованным моделям. Все узлы техники имеют ограниченный ресурс, и при активной эксплуатации однажды ��ыходят из строя. Мы собрали самые частые причины, по которым клиенты обращаются в наш сервис:',
              }}
            ></span>
          </p>
          <ul className="frame1196-ul2 list">
            ...
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                      __html: 'Не запускается стирка — проверяем мо��уль управления или кнопку питания.',
                  }}
                ></span>
              </span>
            </li>
      ...
      <style jsx>
        {`
          ...
          /* Отдел��н���й брейкпо��нт для ��едера */
