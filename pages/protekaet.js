...
const Page = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      imageAlt: '',
      imageCaption: '',
      content: `<p><strong>1. Проверяйте карманы и бере��но укладывайте бельё.</strong> Мелкие детали одежды – пуговицы, заклёпки, монеты – кладите в стиральные мешки.</p>
