  ...
  const sectionsTop = [
    {
      ...
      imageAlt: '',
      imageCaption: '',
      content: `<p><strong>1. Попробуйте сбросить программу штатным способом.</strong><br/>Нажмите кнопку «Стоп» или «Пауза». В некоторых моделях есть отдельные режимы «Слив» или «Отж��м» — выберите их и запустите на минимальных оборотах. Часто такой сброс помогает завершить цикл и вернуть управление.</p>
